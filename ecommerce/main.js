...
window.addEventListener('DOMContentLoaded',()=>{
    axios.get('https://crudcrud.com/api/92491aeba97a4f159144a32da38fc97e/unicorns')
    .then(res=>{
...
function submitForm(e){
    ...
    axios.post('https://crudcrud.com/api/92491aeba97a4f159144a32da38fc97e/unicorns',obj)
    .then(res=>{
        showOutput(res.data);
    })
    .catch(err=>console.log(err));
...
function delFun(id){
    axios.delete(`https://crudcrud.com/api/92491aeba97a4f159144a32da38fc97e/unicorns/${id}`)
    .then(res=>{
        removeFromScreen(id);
    })
    .catch(err=>console.log(err));
